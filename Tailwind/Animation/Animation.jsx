    ...
    const design = (
        <>
            <div className="overflow-hidden relative">
                <div className="flex" style={{ width: `${100 * data.length}%` }}>
                    {
                ...
                {/* right label counter */}
                <div
                    className="absolute right-0 top-0 p-5 h-full flex flex-col justify-between">
                    <label></label>
                    {
...

                {
                    dots ?
                        <div
                            className="absolute bottom-0 left-0 p-5 w-full flex justify-center">
...
const view = (index)=>{
    ...
    const design = (
        <>
            <div ref={main} className={`overflow-hidden  ${vertical ? null : "relative"}`}>
                <div className={`flex gap-4 ${vertical ? "flex-col" : "flex-row"}`}
                    style={{ width: vertical ? "100%" : (25 * data.length) + "%" }}>
                    {
                        springs.map((styles, index) => {
                            return <Anim
                                styles={styles}
